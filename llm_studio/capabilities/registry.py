...
_CAPABILITIES: tuple[CapabilityInfo, ...] = (
    ...
    CapabilityInfo("model_gateway", CapabilityStatus.AVAILABLE, "Model Gateway core routes local generation through provider-neutral interfaces.", False),
    CapabilityInfo("model_profiles", CapabilityStatus.AVAILABLE, "Model profile CRUD and builtin profiles are available through /v1/model-profiles.", False),
    CapabilityInfo("model_profile_local_runtime", CapabilityStatus.AVAILABLE, "local_runtime profiles can be created and used as the default.", False),
    CapabilityInfo("model_profile_fake", CapabilityStatus.AVAILABLE, "fake profiles are available for testing.", False),
    CapabilityInfo("openai_compatible_provider", CapabilityStatus.NOT_IMPLEMENTED, "OpenAI-compatible provider is planned for a later phase.", False),
    CapabilityInfo("deepseek_provider", CapabilityStatus.NOT_IMPLEMENTED, "DeepSeek provider is planned for a later phase.", False),
    CapabilityInfo("writing_provider_switch", CapabilityStatus.NOT_IMPLEMENTED, "Writing provider switching is not implemented yet.", False),
    CapabilityInfo("online_privacy_confirmation", CapabilityStatus.NOT_IMPLEMENTED, "Online privacy confirmation is not implemented yet.", False),
    CapabilityInfo("model_usage_metering", CapabilityStatus.NOT_IMPLEMENTED, "Model usage metering is not implemented yet.", False),
