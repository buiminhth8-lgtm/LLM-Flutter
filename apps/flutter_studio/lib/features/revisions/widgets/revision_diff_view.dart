        ...
        children: [
          Padding(
            ...
            child: Wrap(
              ...
              runSpacing: 8,
              children: [
                _Metric(label: '原文', value: summary.originalChars),
                _Metric(label: '修订稿', value: summary.editedChars),
                _Metric(label: '已新增', value: summary.addedChars),
                _Metric(label: '已删除', value: summary.removedChars),
                _Metric(label: '区块', value: summary.changedBlocks),
              ],
            ),
          ),
