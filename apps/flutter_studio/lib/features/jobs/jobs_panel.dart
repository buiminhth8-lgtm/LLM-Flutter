      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Expanded(
              child: jobs.isEmpty
                  ? const AppEmptyState(title: '没有最近任务', icon: Icons.task_alt_outlined)
                  : ListView.separated(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final progress = map['progress'] is num ? (map['progress'] as num).toDouble().clamp(0.0, 1.0) : null;
                        ...
                        return ListTile(
                          ...
                          title: Row(
                            children: [
                              ...
                              AppStatusBadge(label: status, tone: _tone(status)),
                            ],
                          ),
                          subtitle: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              if (progress != null) AppProgressBar(value: progress, label: '${(progress * 100).toStringAsFixed(1)}%'),
                              if (map['message'] != null) Text('${map['message']}'),
