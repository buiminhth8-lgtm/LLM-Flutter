...
class RoutingHttpClient extends http.BaseClient {
  ...
  Future<http.StreamedResponse> send(http.BaseRequest request) async {
    ...
    requests.add(
      CapturedControllerRequest(request.method, request.url.path, body),
    );
...
void main() {
  test(
    'ModelController refreshes current model and deletes with confirm',
    () async {
  ...
  test(
    'AdapterController sends model context and refreshes adapters',
    () async {
      final httpClient = RoutingHttpClient();
